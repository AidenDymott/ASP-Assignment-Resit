...
void fiber1(){
    Fiber* currentFiber = reinterpret_cast<Fiber*>(get_data());//Create instance of Fiber to get the current fiber.
    ...
    currentFiber -> yield();
    std::cout << "Fiber 1 AFTER: "<< *dp << std::endl;
}
...
int main() {
    ...
    //Create new fiber objs, removed data parameter as its now stored in the memeber variable within the fiber funcs.
    Fiber* f1 = new Fiber(&fiber1, nullptr);
    Fiber* f2 = new Fiber(&fiber2, nullptr);
